...
<Nav.Link className="mt-2">
    ...
    <Accordion.Collapse eventKey="0">
      <Card.Body className="pl-4 ml-2 " style={{borderRadius:"9px",width:"90%", marginTop:"-19px"}}>
          <div className="p-2 pl-4" style={{background:"#F5F5F5",borderRadius:"9px",width:"125%",marginLeft:"-28px"}} >
        <Link to="/eggs"  style={{textDecoration:"none"}}><h6 className="pl-4 pt-1" style={{color:"#223142",fontWeight:"lighter"}}>Dairy & eggs</h6></Link>
        </div>
...
<div style={{background:"#F5F5F5",width:"110%",height:"250vh",paddingRight:"30px"}}>
