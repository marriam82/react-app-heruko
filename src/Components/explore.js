...
import {Navbar,Row,Col,Nav,Container,Image,Card,CardGroup,CardDeck,Badge,Toast,Button,Form,Accordion,Carousel,Modal} from 'react-bootstrap'
...
{/* --------------------- location states---------------------- */}
     ...
     <Modal id="edit-address" show={show113}className="locationside" style={{marginTop:"0.5%",
...
{/* ------------------current location------------- */}
<Modal show={show8} className="c locationstate" style={{borderRadius:"30px ",marginTop:"0.5%",
...
<Nav.Link href="/offers" className="mt-3"
  ...
  <Nav.Link className="mt-1"  style={{color:"#223142"}}><img style={{height:"3vh"}} src={hair}/> &nbsp; &nbsp;&nbsp;Hair Care</Nav.Link>
   ...
   <Nav.Link  onClick={handleShow}  style={{color:"black",fontWeight:"normal",fontSize:"14px",marginRight:"-25px"}} id="no" className="no" ><img src={delivery}style={{height:"3vh"}} />&nbsp; &nbsp; Sen Francisain California &nbsp;<i class="fas fa-angle-down"></i> </Nav.Link>
      <Nav.Link className="ml-4 pl-3"style={{color:"black",fontWeight:"normal",fontSize:"14px"}} id="no">
        <img src={deal}style={{height:"3vh"}} />&nbsp; &nbsp; Best deals &nbsp; <i class="fas fa-angle-down"></i></Nav.Link>
...
<Badge className="badge2"  variant="light" style={{borderRadius:"12px",position:"absolute",right:"1.5%",padding:"6px",background:"#FFDD73",color:"black",bottom:"65%",fontSize:"12px"}}>2</Badge>
 ...
 <h4 className="ramezh1" style={{color:"#223142",fontWeight:"bold", 
 marginTop:"15px",marginLeft:"20px",fontSize:"29px"}}>Ramez Offers</h4>
  ...
  <Link to="/nationalDayOffer" style={{textDecoration:"none"}}>
     <Card.Img variant="top" className="ramezimg"  src={national} style={{height:"25vh",borderRadius:"10px",width:"96%"}}/>
    <p className="mt-2 pl-2 text-muted">National Day Offers</p>
</Link>
</Card>
  <Card style={{border:"0"}}>
    <Card.Img variant="top" className="ramezimg"  src={camp} style={{height:"25vh",borderRadius:"10px",width:"96%"}}/>
    <p className="mt-2 pl-2 text-muted">Camping Season</p>
  </Card>
</CardGroup>
<div className="suggested" style={{background:"#F5F5F5",
height:"130vh",paddingRight:"30px",width:"113%"}}>
  <div style={{display:"flex",justifyContent:"space-between"}}>
<h4 style={{paddingTop:"60px",fontWeight:"bold",fontSize:"30px"}} 
className="pl-4 ml-3 suggestedh1">Suggested Products</h4>
...
<h4 className="pl-2 pprice" style={{color:"#E3424B",marginTop:"-20px",fontWeight:"bold"}}>0.835<span className="text-muted" style={{fontSize:"11px"}}>&nbsp;BDH</span></h4>
 ...
 style={{border:"0",borderBottomLeftRadius:"10px",marginTop:"-10px",
 background:"#FBDB73",borderBottomRightRadius:"10px"}}>
