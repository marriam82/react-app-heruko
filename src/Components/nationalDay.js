...
export default class nationalDay extends Component {
    render() {
        return (
            <>
                 <Container fluid>
...
<div style={{height:"50vh"}}>
    ...
    <h4 style={{color:"#223142",fontWeight:"bold", marginTop:"15px",marginLeft:"20px"}}>National Day Offers</h4>
    <div className="mt-4" style={{width:"106%",height:"700px"}}>
