...
import {Navbar,Row,Col,Nav,Container,Image,Card,CardGroup,CardDeck,Badge,Toast,Button,Form,FormControl,Modal,Accordion} from 'react-bootstrap'
...
<Button style={{width:"150px",height:"7vh",marginLeft:"2%",
     border:"none",background:"#FFDD73",color:"black",borderRadius:"8px"}}>
       <i class="fas fa-shopping-cart"></i> &nbsp;
        Add to Cart</Button>
     <Button style={{border:"none",color:"#BDBDBD",
     position:"",marginTop:"", marginLeft:"2%",
     background:"#F6F6F6"}}>
...
marginTop:"25px",height:"150vh",backgroundImage:`url(${national})`,backgroundSize:"100% 100%"}}>
  <div style={{width:"5%",marginLeft:"15.5%",paddingTop:"9.9%"}}>
    ...
    <div style={{width:"21%",display:"flex",justifyContent:"space-between",marginLeft:"66%",paddingTop:"4.3%"}}>
    <Button onClick={() => setModalShow(true)}  style={{width:"40px",height:"40px",color:"black",border:"none",background:"#FFDD73"}}>
    <i class="fas fa-shopping-cart"></i></Button>         
    <Button onClick={() => setModalShow(true)}  style={{width:"40px",height:"40px",color:"black",background:"#FFDD73", border:"none",marginTop:"10px"}}>
    <i class="fas fa-shopping-cart"></i></Button>         
    </div>

    <div style={{width:"6%",display:"flex",justifyContent:"space-between",marginLeft:"10%",paddingTop:"7.4%"}}>
    <Button onClick={() => setModalShow(true)}  style={{marginLeft:"20%",marginTop:"170%",width:"40px",height:"40px",color:"black",border:"none",background:"#FFDD73"}}>
    <i class="fas fa-shopping-cart"></i></Button>         
    <Button onClick={() => setModalShow(true)}  style={{width:"40px",height:"40px",color:"black",background:"#FFDD73", border:"none"}}>
    <i class="fas fa-shopping-cart"></i></Button>         
    </div>

    <div style={{width:"55%",display:"flex",justifyContent:"space-between",marginLeft:"19%",paddingTop:"26.5%"}}>
    <Button onClick={() => setModalShow(true)}  style={{width:"40px",height:"40px",color:"black",border:"none",background:"#FFDD73"}}>
    <i class="fas fa-shopping-cart"></i> </Button>         
    <Button style={{width:"40px",height:"40px",color:"black",marginLeft:"-5%",background:"#FFDD73",border:"none"}}>
    <i class="fas fa-shopping-cart"></i></Button>  
    <Button onClick={() => setModalShow(true)}  style={{width:"40px",height:"40px",color:"black",border:"none",background:"#FFDD73"}}>
    <i class="fas fa-shopping-cart"></i> </Button>                  
    </div>
