...
<h3 className="ml-4" style={{color:"black",fontWeight:"bold", marginTop:"25px"}}> Explore Catagories</h3>
<div id="all " style={{marginTop:"30px",width:"100%",marginLeft:"22px",}}>
  <Link to="/" style={{textDecoration:"none"}}><Button id="alll"style={{background:"#F6F6F6",
  border:"none",
  ...
  &nbsp;Restaurants</Button>{' '}
     ...
     <Button style={{background:"#E3424B",
  color:"white",border:"none",
  marginLeft:"10px",paddingRight:"40px",
  paddingBottom:"10px",
  height:"7vh", borderRadius:"9px",width:"16%"}}><img src={sup} style={{height:"3vh"}}/>&nbsp;Supermarket</Button>
  <Button style={{
    background:"#F6F6F6",
    color:"black",border:"none",
    marginLeft:"10px",paddingRight:"40px",
...
<Card style={{ width: '22rem',marginTop:"35px" ,marginLeft:"22px",border:"none"}}>
  <Card.Img variant="top" src={img3}style={{height:"30vh",borderRadius:"10px",}} />
